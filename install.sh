...
if [ "$SELECT_THEME" -eq 1 ]; then
 ...
 echo -e "                                                       "
  ...
  if [ "$SELECT_THEME" -eq 8 ]; then
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]                  INSTALLASI THEME                          [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                                   "
  sudo unzip IceMinecraft.zip
  sudo cp -rfT /root/IceMinecraft /var/www/pterodactyl
  curl -sL https://deb.nodesource.com/setup_16.x | sudo -E bash -
  sudo apt install -y nodejs
  sudo npm i -g yarn
  cd /var/www/pterodactyl
  ...
  npm i -g yarn
  yarn
  sudo rm -rf /root/IceMinecraft
  sudo rm -rf /root/resources
  sudo rm -rf /root/README.md
  sudo rm -rf /root/install.sh
  sudo rm -rf /root/repair.sh
  sudo rm -rf /var/www/pterodactyl/README.md
  sudo rm -rf /var/www/pterodactyl/install.sh
  sudo rm -rf /var/www/pterodactyl/repair.sh
  cd 
  cd /var/www/pterodactyl
    php artisan down
  ...
  sudo cp /root/NightAdmin /var/www/pterodactyl
  curl -sL https://deb.nodesource.com/setup_16.x | sudo -E bash -
  sudo apt install -y nodejs
  sudo npm i -g yarn
  cd /var/www/pterodactyl
